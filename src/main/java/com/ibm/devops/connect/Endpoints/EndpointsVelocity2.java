...
public class EndpointsVelocity2 implements IEndpoints {
    private String logPrefix = "[EndpointsVelocity2] EndpointsVelocity2#";
    private static final Logger log = LoggerFactory.getLogger(EndpointsVelocity2.class);
    ...
    public String getVelocityHostname() {
        try {
            ...
            log.error(logPrefix + "No valid URL was provided for Velocity for 2nd Instance: ", e);
        }
        return "";
    }

    private String getBaseUrl() {
        return removeTrailingSlash(Jenkins.getInstance().getDescriptorByType(DevOpsGlobalConfiguration.class).getBaseUrl2());
    }
