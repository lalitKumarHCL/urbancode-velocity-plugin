...
public class CloudWorkListener2 {
    ...
    public void callSecured(ConnectSocket socket, String event, String securityError, Object... args) {
        ...
        String logPrefix = "[UrbanCode Velocity " + entry.getBaseUrl() + "] CloudWorkListener2#callSecured - ";
        ...
        // TODO Don't make this an array in the silly way that I have. I just want this
        // to work
        ...
        for (int i = 0; i < incomingJobs.size(); i++) {
            ...
            // sendResult(socket, incomingJobs.getJSONObject(i).get("id").toString(),
            // WorkStatus.started, "This work has been started");
        }
